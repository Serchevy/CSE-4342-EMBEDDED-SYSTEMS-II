...
;* Date/Time created: Thu Feb 15 11:30:59 2024                                *
;******************************************************************************
...
g_pfnVectors:
	...
	.bits	PinB1ISR,32		; g_pfnVectors[17] @ 544
...
$C$DW$3	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$3, DW_AT_name("PinB1ISR")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("PinB1ISR")
	.dwattr $C$DW$3, DW_AT_declaration
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_decl_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$3, DW_AT_decl_line(0x24)
	.dwattr $C$DW$3, DW_AT_decl_column(0x0d)
	.dwendtag $C$DW$3

;	C:\ti\ccs1240\ccs\tools\compiler\ti-cgt-arm_20.2.7.LTS\bin\armacpia.exe -@C:\\Users\\serva\\AppData\\Local\\Temp\\{7B78ED06-1E41-4B1D-AC0F-08B0A6195B72} 
	.sect	".text"
	.clink
	.thumbfunc ResetISR
	.thumb
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0xef)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$4, DW_AT_decl_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$4, DW_AT_decl_line(0xef)
	.dwattr $C$DW$4, DW_AT_decl_column(0x01)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 240,column 1,is_stmt,address ResetISR,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 245,column 5,is_stmt,isa 1
    .global _c_int00
    b.w     _c_int00
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 247,column 1,is_stmt,isa 1
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        BX        LR                    ; [DPU_V7M3_PIPE] 
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../tm4c1230h6pm_startup_ccs.c")
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 262,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L1||
;*
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
        B         ||$C$L1||             ; [DPU_V7M3_PIPE] |262| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |262| 
;* --------------------------------------------------------------------------*
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 280,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L2||
;*
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
        B         ||$C$L2||             ; [DPU_V7M3_PIPE] |280| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |280| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$7, DW_AT_TI_end_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$7, DW_AT_TI_end_line(0x11b)
...
$C$DW$8	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0x125)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$8, DW_AT_decl_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$8, DW_AT_decl_line(0x125)
	.dwattr $C$DW$8, DW_AT_decl_column(0x01)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 294,column 1,is_stmt,address IntDefaultHandler,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c1230h6pm_startup_ccs.c",line 298,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L3||
;*
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
        B         ||$C$L3||             ; [DPU_V7M3_PIPE] |298| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |298| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$8, DW_AT_TI_end_file("../tm4c1230h6pm_startup_ccs.c")
	.dwattr $C$DW$8, DW_AT_TI_end_line(0x12d)
...
$C$DW$12	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$12, DW_AT_decl_file("C:/ti/ccs1240/ccs/tools/compiler/ti-cgt-arm_20.2.7.LTS/include/machine/_types.h")
	.dwattr $C$DW$12, DW_AT_decl_line(0xa4)
